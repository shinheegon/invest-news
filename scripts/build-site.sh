...
# 1) 데이터 파일 복사 (없으면 건너뜀)
for f in keyword-index.json company-index.json discovery-index.json market-indicators.json latest.md synthesis-3day.md analysis.md discovery.md leading-signals.md review.md; do
