...
# 1) 데이터 파일 복사 (없으면 건너뜀)
for f in keyword-index.json company-index.json discovery-index.json leading-index.json article-archive.json market-indicators.json market-history.json portfolio.json verification.json price-history.json theme-scoreboard.json watch-priority.json miss-analysis.json ai-group.json ai-group-live.json niche-radar.json macro-patterns.json macro-context.json macro-history.json macro-history-agg.json macro-compass.json cross-signal.json value-scorecard.json mock-portfolio.json mock-portfolio-live.json latest.md synthesis-3day.md analysis.md discovery.md leading-signals.md review.md holdings-analysis.md verification.md discovery-learnings.md macro-analog.md; do
