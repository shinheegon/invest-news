...
# 1) 데이터 파일 복사 (없으면 건너뜀)
for f in keyword-index.json company-index.json discovery-index.json leading-index.json article-archive.json market-indicators.json market-history.json portfolio.json verification.json price-history.json theme-scoreboard.json latest.md synthesis-3day.md analysis.md discovery.md leading-signals.md review.md holdings-analysis.md verification.md discovery-learnings.md; do
